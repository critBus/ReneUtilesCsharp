...
namespace ReneUtiles.Clases.BD.Factory.Codes.CSharp
{
    ...
    public class CodeBDCSharp : CodeBDLenguaje_ConIAdmin
    {
        ...
        public override string getStrMetodoMetodoDesactivarConsola_Abstract(int separacion0) {
            ...
            string mr = "";
            mr += separacion1 + getPublicAbstractMetodo() + " " + factory.NombreClaseBDPadre+ " " + getNombreMetodoDesactivarConsola() + "();";
            return mr;
        }
        public override string getStrMetodoMetodoDesactivarConsola(int separacion0)
        {
            ...
            string mr = "";
            mr += separacion1 + getPublicOverrideMetodo() + " " + factory.NombreClaseBDPadre+" "+ getNombreMetodoDesactivarConsola() + "(){";
        ...
        public override string getStrModelo(ModeloBD m, EsquemaBD E, int separacion0)
        {
            ...
            for (int i = 0; i < lm.Count; i++)
            {
                ...
                if (!nombreMetodosAgregados.Contains(nombreMetodoAdd))
                {
                    ...
                    mr += separacion2 + "if (!this.apibd." + getNombreMetodoExiste_ManyToMany(o);
                        //+ "(this.idkey," + nombreModeloLowerActual + ".idkey)){";

                    //if (mDestino == o.Many_1)
                    //{
                    //    mr += "(" + nombreModeloLowerActual + ".idkey,this.idkey)";
                    //}
                    //else
                    //{
                    //    mr += "(this.idkey," + nombreModeloLowerActual + ".idkey)";
                    //}
                    mr += cabezalMtM+"){";
                ...
                if (!nombreMetodosAgregados.Contains(nombreMetodoRemove))
                {
                    ...
                    mr += separacion1 + "public void " + nombreMetodoRemove + "(" + nombreModeloActual + " " + nombreModeloLowerActual + "){";
        ...
        public override string getStrMetodoInsertar(ModeloBD_ID m, int separacion0)
        {
            ...
            mr += separacion3 + nombreModeloLower+ ".idkey=this.BD." + getDSC().NombreMetodoGetIdCorrespondiente + "(" + nombreModelo + "." + this.getStrStaticTabla(m) +","+getStrLlamadaACoumnaIdkeyDefault(m)+");";
